  ...
  if (direction === 'horizontal') {
    return (
      <div className={`flex items-center justify-center gap-3 w-full my-6 ${className}`}>
        <div className="h-[1px] flex-1 bg-gradient-to-r from-transparent via-gold-500/40 to-gold-500" />
        <div className="flex items-center gap-1.5 text-gold-600">
          <span className="w-1.5 h-1.5 rotate-45 border border-gold-400 bg-white" />
          <span className="w-2.5 h-2.5 rotate-45 bg-gold-gradient shadow-sm" />
          <span className="w-1.5 h-1.5 rotate-45 border border-gold-400 bg-white" />
        </div>
        <div className="h-[1px] flex-1 bg-gradient-to-l from-transparent via-gold-500/40 to-gold-500" />
      </div>
    );
  }
  ...
  return (
    <div className={`hidden lg:flex flex-col items-center gap-4 py-8 pointer-events-none select-none ${className}`}>
      ...
      <div className="flex flex-col items-center gap-2 text-gold-600">
        <span className="w-2 h-2 rotate-45 border border-gold-400 bg-white" />
        <span className="w-3.5 h-3.5 rotate-45 bg-gold-gradient shadow-sm" />
        <span className="w-2 h-2 rotate-45 border border-gold-400 bg-white" />
      </div>
