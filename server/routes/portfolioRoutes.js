...
let fallbackPortfolio = [
  {
    ...
    overview: 'AuraFintech required a unified AI knowledge hub capable of analyzing millions of regulatory filings, market intelligence documents, and trade records in real time.',
    challenge: 'Manual compliance document analysis caused massive research delays, while legacy keyword search systems produced high false-positive rates.',
    solution: 'Engineered a custom Retrieval-Augmented Generation (RAG) pipeline utilizing vector embeddings, distributed Python microservices, and sub-100ms vector search querying.',
  ...
  },
  {
    ...
    overview: 'Designed for high-throughput global logistics tracking, handling over 50,000 requests per second across AWS and multi-region bare metal instances.',
    challenge: 'Unpredictable traffic spikes caused cloud cost overruns and manual scaling bottlenecks during peak seasonal demand.',
    solution: 'Built a custom Go-based predictive autoscaler integrated with Prometheus metrics and eBPF kernel event listeners for automated node scaling.',
  ...
  },
  {
    ...
    overview: 'A comprehensive digital healthcare platform uniting patients, doctors, and pharmacy networks into a single encrypted mobile application.',
    challenge: 'Legacy telehealth platforms suffered from video stream lag, fragmented patient records, and non-compliant data storage risks.',
    solution: 'Implemented end-to-end WebRTC video streaming, Node.js WebSocket notification layers, and HIPAA-compliant AES-256 data encryption at rest and in transit.',
